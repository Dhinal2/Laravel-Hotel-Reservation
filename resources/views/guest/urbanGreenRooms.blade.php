                ...
                <div class="room__wrapper">
                    <div class="room__card is__style__four">
                        <div class="room__card__top">
                            <div class="room__card__image">
                                <a href="#">
                                    <img src="assets/images/pages/room/1.webp" width="645" height="438" alt="room card">
                                </a>
                            </div>
                        </div>
                        <div class="room__card__meta">
                            <a href="#" class="room__card__title h4">Executive Room</a>
                            ...
                            <div class="room__price__tag">
                                <span class="h5 d-block">120$</span>
                            </div>
                    ...
                    <div class="room__card is__style__four">
                        <div class="room__card__top">
                            <div class="room__card__image">
                                <a href="#">
                                    <img src="assets/images/pages/room/2.webp" width="645" height="438" alt="room card">
                                </a>
                            </div>
                        </div>
                        <div class="room__card__meta">
                            <a href="#" class="room__card__title h4">Single Room</a>
                            <div class="room__card__meta__info">
                                <span><i class="flaticon-construction"></i>Size: 35 sqm</span>
                                <span><i class="flaticon-user"></i>Person: 5 Person</span>
                            </div>
                            <p class="font-sm">Also known as a Classic Room or Single Room, this is the most basic type of room, usually featuring essential amenities.</p>
                            <div class="room__price__tag">
                                <span class="h5 d-block">140$</span>
                            </div>
                            <a href="#" class="room__card__link">Discover More</a>
                    ...
                    <div class="room__card is__style__four">
                        <div class="room__card__top">
                            <div class="room__card__image">
                                <a href="#">
                                    <img src="assets/images/pages/room/3.webp" width="645" height="438" alt="room card">
                                </a>
                            </div>
                        </div>
                        <div class="room__card__meta">
                            <a href="#" class="room__card__title h4">Tripple Room</a>
                            <div class="room__card__meta__info">
                                <span><i class="flaticon-construction"></i>Size: 35 sqm</span>
                                <span><i class="flaticon-user"></i>Person: 5 Person</span>
                            </div>
                    ...
                    <div class="room__card is__style__four">
                        <div class="room__card__top">
                            <div class="room__card__image">
                                <a href="#">
                                    <img src="assets/images/pages/room/4.webp" width="645" height="438" alt="room card">
                                </a>
                            </div>
                        </div>
                        <div class="room__card__meta">
                            <a href="#" class="room__card__title h4">Connecting Room</a>
                            <div class="room__card__meta__info">
                                <span><i class="flaticon-construction"></i>Size: 35 sqm</span>
                                <span><i class="flaticon-user"></i>Person: 5 Person</span>
                            </div>
                    ...
                    <div class="room__card is__style__four">
                        <div class="room__card__top">
                            <div class="room__card__image">
                                <a href="#">
                                    <img src="assets/images/pages/room/5.webp" width="645" height="438" alt="room card">
                                </a>
                            </div>
                        </div>
                        <div class="room__card__meta">
                            <a href="#" class="room__card__title h4">Accessible Room</a>
                            <div class="room__card__meta__info">
                                <span><i class="flaticon-construction"></i>Size: 35 sqm</span>
                                <span><i class="flaticon-user"></i>Person: 5 Person</span>
                            </div>
                    ...
                    <div class="room__card is__style__four">
                        <div class="room__card__top">
                            <div class="room__card__image">
                                <a href="#">
                                    <img src="assets/images/pages/room/6.webp" width="645" height="438" alt="room card">
                                </a>
                            </div>
                        </div>
                        <div class="room__card__meta">
                            <a href="#" class="room__card__title h4">Double Room</a>
                            <div class="room__card__meta__info">
                                <span><i class="flaticon-construction"></i>Size: 35 sqm</span>
                                <span><i class="flaticon-user"></i>Person: 5 Person</span>
                            </div>
